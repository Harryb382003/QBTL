package QBTL::Process::QBT::ExportInfill;
        ...
        push @problem,
            {
             ...
             path  => $path,
             hash  => $hash,
             error => 'export infill parse failed',
        ...
        push @problem,
            {
             ...
             path  => $path,
             hash  => $hash,
             error => 'export infill source hash mismatch',
             expected_hash => $hash,
